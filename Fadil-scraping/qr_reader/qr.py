...
# Modify the main section like this:
if __name__ == '__main__':
    ...
    # Replace camera capture with image reading
    if len(sys.argv) > 1:
        image_path = sys.argv[1]
    else:
        image_path = '/Users/fadil/Documents/capstone/qr_reader/Dataset/PowerBank/8.jpg'  # Replace with your actual image path
    ...
    if out is not None:
        ...
        if not data:
            ...
            print('URL:', qrdata)  # Print the URL link
            draw_str(frame, (20, 20), "QR Found!")
            draw_str(frame, (20, 40), "URL: {0}".format(str(qrdata)))

        # Navigate to the website link
            if qrdata.startswith("http://") or qrdata.startswith("https://"):
...
# Wait for 10 seconds (10000 milliseconds) before proceeding
cv2.waitKey(10000)
