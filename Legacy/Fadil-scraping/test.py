...
# Timing parameters
PAGE_SEARCH_PAUSE_TIME = 6       # Time to wait between page search scrolls (seconds)
PAGE_SEARCH_MAX_SCROLLS = 50      # Maximum number of scrolls when searching for pages
GROUP_SEARCH_PAUSE_TIME = 6      # Time to wait between group search scrolls (seconds)
...
POST_NO_CHANGE_LIMIT = 5         # Number of consecutive scrolls with no new posts before stopping
...
MARKETPLACE_SCROLL_TIMES = 100     # Number of times to scroll in marketplace search
MARKETPLACE_PAUSE_TIME = 10        # Time to wait between marketplace scrolls (seconds)
MARKETPLACE_ITEM_WAIT_TIME = 5    # Time to wait after loading an item page (seconds)
